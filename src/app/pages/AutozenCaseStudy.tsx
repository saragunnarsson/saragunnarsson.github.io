...
import imgAutozenPhone from "figma:asset/ac121c8480b9c211e8dade76bf8abe69216bffbc.png";
...
export function AutozenCaseStudy() {
  ...
  return (
    <div className="bg-[#fafbff] min-h-screen relative overflow-x-hidden">
      ...
      {/* Hero Section - 8px gap from top and sides */}
      <section 
          ...
          <div className="flex flex-col xl:flex-row gap-[24px] sm:gap-[28px] md:gap-[32px] items-start xl:items-center xl:justify-center">
            <div className="w-full xl:max-w-[756px] xl:flex-1 flex flex-col gap-[20px] sm:gap-[28px] md:gap-[32px] lg:gap-[37px]">
              <div className="flex flex-col gap-[10px] md:gap-[12px] lg:gap-[17px]">
                <div className="bg-[#f4f4ff] inline-flex rounded-[10px] self-start relative">
                  ...
                  <div className="flex items-center justify-center px-[11px] py-[4px]">
                    <p className="font-medium leading-[20px] text-[#0c0faf] text-[11px] sm:text-[12px] md:text-[13px]">{`Marketplace Funnel Optimization & Product Strategy`}</p>
                  </div>
                </div>
                <h1 className="font-bold text-[#0a0a0a] text-[32px] leading-[42px] sm:text-[38px] sm:leading-[48px] md:text-[48px] md:leading-[60px] lg:text-[56px] lg:leading-[68px] xl:text-[65px] xl:leading-[77px]">Autozen</h1>
              </div>
              <p className="font-normal text-black text-[15px] leading-[25px] sm:text-[16px] sm:leading-[26px] md:text-[17px] md:leading-[28px] lg:text-[18px] lg:leading-[32px]">
                Autozen is a digital marketplace designed to simplify the process of selling a used vehicle.
              </p>
              <p className="font-normal text-black max-w-[706px] text-[15px] leading-[25px] sm:text-[16px] sm:leading-[26px] md:text-[17px] md:leading-[28px] lg:text-[18px] lg:leading-[32px]">Working from internal funnel data, Skandi evaluated the seller onboarding experience to identify key drop-off points. Each step was then systematically redesigned to reduce friction and improve completion rates across the MVP.</p>
              <div className="flex gap-[10px] md:gap-[12px] lg:gap-[14px] items-center">
                <div className="shrink-0 size-[20px] sm:size-[22px] md:size-[24px] lg:size-[31px] relative">
                  <div className="absolute inset-[6.25%_16.67%]">
                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.6667 27.125">
                      <path d={svgPaths.pe9fb00} fill="black" />
                    </svg>
                  </div>
                </div>
                <p className="flex-1 font-semibold text-black text-[13px] leading-[20px] sm:text-[14px] sm:leading-[22px] md:text-[15px] md:leading-[24px] lg:text-[17px] lg:leading-[26px]">Winner of Vancouver UX Award for Best Retail Experience</p>
              </div>
            </div>
            <div className="w-full xl:w-[450px] flex flex-wrap gap-[10px] md:gap-[12px] lg:gap-[16px] xl:pt-[115px] xl:pb-[13px] xl:shrink-0">
              <Tag text="Funnel Evaluation" />
              <Tag text="Product Strategy" />
              <Tag text="UX/UI Design" />
              <Tag text="Design System Upgrade" />
      ...
      {/* Content Sections */}
      <div className="max-w-[1200px] mx-auto -mt-[90px] sm:-mt-[60px] md:-mt-[110px] lg:-mt-[170px] flex flex-col gap-[20px] relative z-10 px-[30px] sm:px-[40px] pt-[0px] pb-[70px] sm:pb-[50px]">
        {/* The Context */}
        <AnimatedSection>
          <div className="bg-white rounded-[30px] md:rounded-[40px] shadow-[0px_0px_16.44px_0px_rgba(21,20,72,0.08)] px-[30px] md:px-[60px] py-[30px] md:py-[50px] flex flex-col gap-[10px]">
            ...
            <div className="max-w-[701px] lg:max-w-[500px] xl:max-w-[701px]">
              <p className="font-normal text-black mb-[10px] text-[14px] leading-[22px] sm:text-[15px] sm:leading-[24px] md:text-[16px] md:leading-[26px] lg:text-[17px] lg:leading-[27.6px]">
                Autozen's marketplace allows car owners to sell their vehicles through a guided digital process. While the platform was gaining traction, internal funnel data revealed several points in the onboarding experience where sellers were dropping off.
              </p>
              <p className="font-normal text-black text-[14px] leading-[22px] sm:text-[15px] sm:leading-[24px] md:text-[16px] md:leading-[26px] lg:text-[17px] lg:leading-[27.6px]">
                The goal was to identify areas of friction and improve completion rates across the MVP onboarding flow.
              </p>
            </div>
          </div>
        </AnimatedSection>
            ...
            <div className="flex flex-col lg:flex-row gap-[30px] lg:gap-[40px]">
              <div className="flex-1 lg:max-w-[620px] flex flex-col gap-[24px] md:gap-[30px] lg:gap-[43px]">
                <ul className="font-normal text-black list-disc pl-[24px] md:pl-[30px] space-y-[8px] md:space-y-[10px] text-[14px] leading-[22px] sm:text-[15px] sm:leading-[24px] md:text-[16px] md:leading-[26px] lg:text-[17px] lg:leading-[27.6px]">
                  <li>Evaluated the seller onboarding experience using internal funnel data highlighting key drop-off points</li>
                  <li>Identified friction and usability issues across the onboarding journey</li>
                  <li>Systematically refined each step of the flow to improve clarity and reduce cognitive load</li>
                  <li>Simplified form structures, instructions, and progress cues to better guide users through the process</li>
                </ul>
                <div className="bg-[#f6f4ff] rounded-[10px] px-[18px] md:px-[20px] lg:px-[25px] py-[14px] md:py-[16px] lg:py-[20px] relative">
                  ...
                  <p className="font-normal text-black relative text-[14px] leading-[22px] sm:text-[15px] sm:leading-[24px] md:text-[16px] md:leading-[26px] lg:text-[17px] lg:leading-[27px]">
                    <span className="font-semibold">Rather than isolated fixes, </span>
                    <span>each improvement supported a broader restructuring of the seller experience.</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <AnimatedSection delay={0.2}>
          <div className="bg-white rounded-[30px] md:rounded-[40px] shadow-[0px_0px_16.44px_0px_rgba(21,20,72,0.08)] px-[30px] md:px-[60px] py-[30px] md:py-[50px] flex flex-col gap-[10px] relative overflow-visible">
            ...
            <ul className="font-normal text-black list-disc pl-[24px] md:pl-[30px] space-y-[8px] md:space-y-[10px] text-[14px] leading-[22px] sm:text-[15px] sm:leading-[24px] md:text-[16px] md:leading-[26px] lg:text-[17px] lg:leading-[27.6px]">
              <li>A clearer and more structured onboarding experience for sellers</li>
              <li>Reduced friction across key steps of the onboarding journey</li>
              <li>A stronger and more intuitive MVP experience overall</li>
              <li>Recognized with the 2023 Vancouver UX Awards — Best Retail Experience</li>
            </ul>
      ...
      <AnimatedSection delay={0.3}>
        ...
        <div className="md:hidden w-full mb-[100px]">
          <MobileSellerJourney />
        </div>
