...
import imgShoppingCart from "figma:asset/5519c15cc95377e7fff7a20027380824f59f1c3d.png";
import imgSelectCurrency from "figma:asset/845190d0b4c9bc9ca1e0f4ced39d1b35eca2222d.png";
import imgPaymentInterface from "figma:asset/ef6cd9620de627a4d78d3ff8a1839b6a30b9ed2c.png";
import imgConfirmation from "figma:asset/b339026a24c43ae435aae63392ae94079258e4c7.png";
...
export function MobileCryptoCheckout() {
  return (
    <div className="flex flex-col items-center px-[24px] pt-[90px] pb-[40px]" style={{ backgroundImage: "linear-gradient(156deg, #E7F3FF 0%, #F3E7FF 100%)" }}>
      {/* Title */}
      ...
      <div className="w-full max-w-[340px] pt-[10px]">
        <StepDescription>
          At checkout, Josh selects cryptocurrency as his preferred payment method.
        </StepDescription>
        <img
          src={imgShoppingCart}
      ...
      <div className="w-full max-w-[340px] pt-[10px]">
        <StepDescription>
          A secure redirect to NetCents presents supported currencies, allowing him to select Ethereum.
        </StepDescription>
        <img
      ...
      <div className="w-full max-w-[340px] pt-[10px]">
        <StepDescription>
          A structured payment interface simplifies wallet connection and guides completion.
        </StepDescription>
        <img
      ...
      <div className="w-full max-w-[340px] pt-[10px]">
        <StepDescription>
          A clear confirmation state reinforces trust before returning Josh to the checkout flow.
        </StepDescription>
        <img
          src={imgConfirmation}
