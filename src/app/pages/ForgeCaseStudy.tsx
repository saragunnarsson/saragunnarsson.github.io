...
import imgForgeDesign from "figma:asset/f42cf35f18ecba4bbca996d4f87373602830732c.png";
import imgForgeWebsite from "figma:asset/75adac05843b30fef4e2293fc3d842442f439f4f.png";
...
function Tag({ text }: TagProps) {
  return (
    <div className="bg-[rgba(255,255,255,0.5)] flex gap-[5px] items-center justify-center px-[10px] sm:px-[12px] py-[7px] sm:py-[9px] rounded-[10px] shrink-0 relative">
      ...
      <p className="font-medium shrink-0 text-[#0a0a0a] text-center text-[13px] leading-[20px] sm:text-[15px] sm:leading-[23px]">{text}</p>
    </div>
  );
}
...
export function ForgeCaseStudy() {
  ...
  return (
    <div className="bg-[#fafbff] min-h-screen relative overflow-x-hidden">
      {/* Navbar */}
      <nav className={`fixed top-0 left-0 right-0 z-[100] transition-all ${isScrolled ? 'bg-white/5 backdrop-blur-sm border-b border-white/30 shadow-sm' : ''}`}>
        <div className={`mx-auto flex items-center justify-between lg:mx-[75px] ${isScrolled ? 'md:mt-[8px]' : 'md:mt-[18px]'} md:mb-[0px] px-[26px] sm:px-[40px] md:px-[60px] lg:px-[32px] py-[12px]`} style={{ maxWidth: '2000px' }}>
          ...
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            <a href="/#work-section" onClick={handleWorkClick} className={`${isOverDark ? 'text-white hover:text-gray-200' : 'text-gray-700 hover:text-gray-900'} transition-colors font-semibold`}>
              Work
            </a>
            <a 
              href="/#contact" 
      ...
      <section 
        ...
        style={{ backgroundImage: "linear-gradient(156.188deg, rgb(231, 243, 255) 0%, rgb(243, 231, 255) 100%)" }}
      >
        <AnimatedSection>
          <div className="flex flex-col xl:flex-row gap-[24px] sm:gap-[28px] md:gap-[32px] items-start xl:items-center xl:justify-center">
            <div className="w-full xl:max-w-[756px] xl:flex-1 flex flex-col gap-[20px] sm:gap-[28px] md:gap-[32px] lg:gap-[37px]">
              <div className="flex flex-col gap-[10px] md:gap-[12px] lg:gap-[17px]">
                <div className="bg-[#fdf4ff] inline-flex rounded-[10px] self-start relative">
                  ...
                  <div className="flex items-center justify-center px-[11px] py-[4px]">
                    <p className="font-medium leading-[20px] text-[#69027e] text-[11px] sm:text-[12px] md:text-[13px]">Brand Identity & Website Redesign</p>
                  </div>
                </div>
                <h1 className="font-bold text-[#0a0a0a] text-[32px] leading-[42px] sm:text-[38px] sm:leading-[48px] md:text-[48px] md:leading-[60px] lg:text-[56px] lg:leading-[68px] xl:text-[65px] xl:leading-[77px]">Forge</h1>
              </div>
              <div className="flex flex-col gap-[12px] md:gap-[14px] lg:gap-[16px]">
                <p className="font-normal text-black text-[15px] leading-[25px] sm:text-[16px] sm:leading-[26px] md:text-[17px] md:leading-[28px] lg:text-[18px] lg:leading-[32px]">
                  Forge is a service design and digital transformation consultancy working across government and industry.
                </p>
                <p className="font-normal text-black max-w-[706px] text-[15px] leading-[25px] sm:text-[16px] sm:leading-[26px] md:text-[17px] md:leading-[28px] lg:text-[18px] lg:leading-[32px]">Skandi partnered with Forge to modernize their visual identity and translate it into a cohesive digital experience.</p>
              </div>
            </div>
            <div className="w-full xl:w-[450px] flex flex-wrap gap-[10px] md:gap-[12px] lg:gap-[16px] xl:pt-[115px] xl:pb-[13px] xl:shrink-0">
              <Tag text="Brand Identity Design" />
              <Tag text="Logo Design" />
              <Tag text="Color System Development" />
              <Tag text="Web Design" />
            </div>
          </div>
        </AnimatedSection>
      ...
      {/* Content Sections */}
      <div className="max-w-[1200px] mx-auto px-[30px] sm:px-[24px] md:px-[40px] -mt-[90px] sm:-mt-[60px] md:-mt-[110px] lg:-mt-[170px] pb-0 flex flex-col gap-[20px] relative z-10">
        {/* The Context */}
        <AnimatedSection>
          <div className="bg-white rounded-[30px] md:rounded-[40px] shadow-[0px_0px_16.44px_0px_rgba(21,20,72,0.08)] px-[30px] md:px-[60px] py-[30px] md:py-[50px] flex flex-col gap-[10px]">
            <h2 className="font-bold text-[#0a0a0a] text-[24px] leading-[32px] sm:text-[28px] sm:leading-[36px] md:text-[30px] md:leading-[38px] lg:text-[33px] lg:leading-[42px] mb-[8px] md:mb-[10px]">The Context</h2>
            <div className="max-w-[701px] lg:max-w-[500px] xl:max-w-[701px]">
              <p className="font-normal text-black mb-[10px] text-[14px] leading-[22px] sm:text-[15px] sm:leading-[24px] md:text-[16px] md:leading-[26px] lg:text-[17px] lg:leading-[27.6px]">
                Forge was ready to evolve their brand presence to better reflect their maturity and positioning.
              </p>
              <p className="font-normal text-black text-[14px] leading-[22px] sm:text-[15px] sm:leading-[24px] md:text-[16px] md:leading-[26px] lg:text-[17px] lg:leading-[27.6px]">
                The goal was to modernize the visual identity — including logo and color system — and align the website with this new direction.
              </p>
            </div>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection delay={0.1}>
          <div className="bg-white rounded-[30px] md:rounded-[40px] shadow-[0px_0px_16.44px_0px_rgba(21,20,72,0.08)] px-[30px] md:px-[60px] py-[30px] md:py-[50px] flex flex-col gap-[20px] relative overflow-visible">
            <h2 className="font-bold text-[#0a0a0a] text-[24px] leading-[32px] sm:text-[28px] sm:leading-[36px] md:text-[30px] md:leading-[38px] lg:text-[33px] lg:leading-[42px] mb-[8px] md:mb-[10px]">The Approach</h2>
            <div className="flex flex-col lg:flex-row gap-[30px] lg:gap-[40px]">
              <div className="flex-1 lg:max-w-[620px] flex flex-col gap-[24px] md:gap-[30px] lg:gap-[43px]">
                <ul className="font-normal text-black list-disc pl-[24px] md:pl-[30px] space-y-[8px] md:space-y-[10px] text-[14px] leading-[22px] sm:text-[15px] sm:leading-[24px] md:text-[16px] md:leading-[26px] lg:text-[17px] lg:leading-[27.6px]">
                  <li>Designed an updated logo reflecting a more refined, contemporary direction</li>
                  <li>Developed a modernized brand color palette</li>
                  <li>Established a cohesive visual identity system</li>
                  <li>Applied the new brand across a fully redesigned website</li>
                  <li>Refined layout structure and hierarchy for improved clarity</li>
                  <li>Ensured responsive, consistent execution across devices</li>
                </ul>
                <div className="bg-[#f6f4ff] rounded-[10px] px-[18px] md:px-[20px] lg:px-[25px] py-[14px] md:py-[16px] lg:py-[20px] relative">
                  ...
                  <p className="font-normal text-black relative text-[14px] leading-[22px] sm:text-[15px] sm:leading-[24px] md:text-[16px] md:leading-[26px] lg:text-[17px] lg:leading-[27px]">
                    <span>The focus was clarity, cohesion, and elevating the brand's digital presence.</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <AnimatedSection delay={0.2}>
          <div className="bg-white rounded-[30px] md:rounded-[40px] shadow-[0px_0px_16.44px_0px_rgba(21,20,72,0.08)] px-[30px] md:px-[60px] py-[30px] md:py-[50px] flex flex-col gap-[20px] relative overflow-visible">
            <h2 className="font-bold text-[#0a0a0a] text-[24px] leading-[32px] sm:text-[28px] sm:leading-[36px] md:text-[30px] md:leading-[38px] lg:text-[33px] lg:leading-[42px] mb-[8px] md:mb-[10px]">The Outcome</h2>
            <div className="flex-1 lg:max-w-[620px] flex flex-col gap-[24px] md:gap-[30px] lg:gap-[43px]">
              <ul className="font-normal text-black list-disc pl-[24px] md:pl-[30px] space-y-[8px] md:space-y-[10px] text-[14px] leading-[22px] sm:text-[15px] sm:leading-[24px] md:text-[16px] md:leading-[26px] lg:text-[17px] lg:leading-[27.6px]">
                <li>A modernized brand identity aligned with Forge's positioning</li>
                <li>A cohesive visual system across logo, color, and web</li>
                <li>Improved visual hierarchy and usability</li>
                <li>A professional, contemporary digital presence</li>
              </ul>
              <div className="bg-[#f6f4ff] rounded-[10px] px-[18px] md:px-[20px] lg:px-[25px] py-[14px] md:py-[16px] lg:py-[20px] relative">
                <div aria-hidden="true" className="absolute border-2 border-[#d7cbe6] border-solid inset-0 pointer-events-none rounded-[10px]" />
                <p className="font-normal text-black relative text-[14px] leading-[22px] sm:text-[15px] sm:leading-[24px] md:text-[16px] md:leading-[26px] lg:text-[17px] lg:leading-[27px]">
                  <span>The updated brand and website now reflect the strength and credibility of Forge's work.</span>
                </p>
              </div>
            </div>
      ...
      {/* Web Design & Brand Application Section - Full Width */}
      <AnimatedSection delay={0.3}>
        <div className="relative w-full pt-[80px] md:pt-[100px] pb-[80px] lg:pb-[100px] mb-[100px] md:mb-[140px] lg:mb-[180px] overflow-x-clip overflow-y-visible">
          <div className="relative w-full">
            {/* Background gradient - stays at left edge, scales like Recurring Invoices */}
            <div className="absolute left-0 top-0">
              <div className="origin-top-left md:scale-[0.66] lg:scale-[0.75] xl:scale-[0.87] scale-[0.55]">
                <Frame1408Background />
              </div>
            </div>
            {/* Content positioned on top, mockup overflows beyond gradient */}
            <div className="relative z-10 max-w-[1200px] mx-auto px-[24px] md:px-[40px] pt-[100px] sm:pt-[110px] md:pt-[120px] lg:pt-[140px] pb-[20px]">
              <div className="w-full max-w-[770px] mx-auto md:mx-0 md:ml-[calc(50%-385px-80px)]">
                <h2
                  className="text-[#0a0a0a] text-center md:text-left text-[24px] leading-[32px] sm:text-[28px] sm:leading-[36px] md:text-[30px] md:leading-[38px] lg:text-[33px] lg:leading-[42px] mb-[30px] sm:mb-[40px] md:mb-[50px]"
              ...
              <div className="px-[0px] pt-[20px] pb-[0px]">
                <div className="flex flex-col md:flex-row justify-between items-start gap-6">
                  <p className="text-white/70 text-left lg:text-center w-full text-[9px] lg:text-[12px] text-[#ffffff3b]">
                    &copy; {new Date().getFullYear()} Skandi. Independent Product & Design Partner.
                  </p>
                </div>
              </div>
            </div>
