...
function BackgroundImage1({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="bg-white relative rounded-[40px] shadow-[0px_0px_16.44px_0px_rgba(21,20,72,0.08)] shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[10px] items-start px-[60px] py-[40px] relative w-full">{children}</div>
    </div>
  );
}
    ...
    <div className="bg-[#fafbff] relative size-full" data-name="Autozen">
      <div className="-translate-x-1/2 absolute content-stretch flex flex-col h-[861px] items-start left-[calc(50%+0.5px)] pb-[200px] pt-[180px] px-[360px] rounded-[54px] top-[9px] w-[1951px]" data-name="Section" style={{ backgroundImage: "linear-gradient(156.188deg, rgb(231, 243, 255) 0%, rgb(243, 231, 255) 100%)" }}>
        <div className="content-stretch flex gap-[32px] items-center relative shrink-0 w-full">
          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[37px] items-start min-h-px min-w-px relative rounded-[50px]" data-name="Container">
            <div className="content-stretch flex flex-col gap-[17px] items-start relative shrink-0 w-full">
              ...
              <p className="font-['Lexend_Deca:Bold',sans-serif] font-bold leading-[86.2px] min-w-full relative shrink-0 text-[#0a0a0a] text-[72px] w-[min-content] whitespace-pre-wrap">Autozen</p>
            </div>
      ...
      <div className="-translate-x-1/2 absolute bg-[#232034] bottom-[28px] content-stretch flex flex-col items-start left-1/2 pb-[109px] pt-[82px] px-[82px] rounded-[24px] w-[1918px]" data-name="Container">
        <div aria-hidden="true" className="absolute border border-[#c3e0ef] border-solid inset-0 pointer-events-none rounded-[24px]" />
      ...
      <div className="absolute content-stretch flex flex-col gap-[20px] items-center left-[345px] top-[707px] w-[1200px]">
        <BackgroundImage1>
          <p className="font-['Lexend_Deca:Bold',sans-serif] font-bold leading-[57.6px] min-w-full relative shrink-0 text-[#0a0a0a] text-[34px] w-[min-content] whitespace-pre-wrap">The Context</p>
        ...
        <div className="bg-white relative rounded-[40px] shadow-[0px_0px_16.44px_0px_rgba(21,20,72,0.08)] shrink-0 w-full">
          <div className="content-stretch flex flex-col gap-[20px] items-start px-[60px] py-[40px] relative w-full">
            <p className="font-['Lexend_Deca:Bold',sans-serif] font-bold leading-[57.6px] min-w-full relative shrink-0 text-[#0a0a0a] text-[34px] w-[min-content] whitespace-pre-wrap">The Approach</p>
              ...
              <div className="content-stretch flex flex-[1_0_0] flex-col gap-[43px] items-center justify-center min-h-px min-w-px relative">
                <ul className="block font-['Inter:Regular',sans-serif] font-normal leading-[0] list-disc not-italic relative shrink-0 text-[20px] text-black w-full whitespace-pre-wrap">
                  <li className="mb-[10px] ms-[30px]">
                    <span className="leading-[32px]">Audited the full end-to-end seller onboarding funnel</span>
                  </li>
                  <li className="mb-[10px] ms-[30px]">
                    <span className="leading-[32px]">Identified major drop-off points and friction areas</span>
                  </li>
                  <li className="mb-[10px] ms-[30px]">
                    <span className="leading-[32px]">Restructured onboarding flows to reduce cognitive load</span>
                  </li>
                  <li className="mb-[10px] ms-[30px]">
                    <span className="leading-[32px]">Clarified decision stages and strengthened user guidance</span>
                  </li>
                  <li className="mb-[10px] ms-[30px]">
                    <span className="leading-[32px]">Improved hierarchy and interaction patterns across the MVP</span>
                  </li>
                  <li className="mb-[10px] ms-[30px]">
                    <span className="leading-[32px]">Collaborated closely with product and engineering to implement iterative improvements</span>
                  </li>
                  <li className="ms-[30px]">
                    <span className="leading-[32px]">Rather than isolated fixes, each improvement supported a broader restructuring of the seller experience.</span>
                  </li>
                </ul>
                  ...
                  <div className="flex flex-row items-center justify-center size-full">
                    <div className="content-stretch flex items-center justify-center px-[25px] py-[20px] relative w-full">
                      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-h-px min-w-px not-italic relative text-[20px] text-black whitespace-pre-wrap">
                        ...
                        <span className="font-['Inter:Regular',sans-serif] font-normal leading-[30px]">each improvement supported a broader restructuring of the seller experience.</span>
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="absolute content-stretch flex flex-col items-center left-[849.25px] shadow-[0px_0px_16.44px_0px_rgba(21,20,72,0.08)] top-[-182px]">
              <div className="h-[509px] relative rounded-[59px] shrink-0 w-[530px]" data-name="image 7">
        ...
        <BackgroundImage1>
          <p className="font-['Lexend_Deca:Bold',sans-serif] font-bold leading-[57.6px] relative shrink-0 text-[#0a0a0a] text-[34px] w-full whitespace-pre-wrap">The Outcome</p>
          <div className="content-stretch flex items-center justify-center relative shrink-0 w-full">
            <ul className="block flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[0] list-disc min-h-px min-w-px not-italic relative text-[20px] text-black whitespace-pre-wrap">
              <li className="mb-[10px] ms-[30px]">
                <span className="leading-[32px]">Reduced friction across key onboarding stages</span>
              </li>
              <li className="mb-[10px] ms-[30px]">
                <span className="leading-[32px]">Stronger flow continuity from valuation to transaction</span>
              </li>
              <li className="mb-[10px] ms-[30px]">
                <span className="leading-[32px]">A more cohesive and scalable MVP</span>
              </li>
              <li className="ms-[30px]">
                <span className="leading-[32px]">Improved alignment between user behaviour and business goals</span>
              </li>
            </ul>
          </div>
        </BackgroundImage1>
